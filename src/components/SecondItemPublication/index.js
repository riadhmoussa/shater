...
const SecondItemPublication = () => {
  return (
    ...
    overflow: "hidden",}}>
      ...
      <View style={{position: 'absolute',top:0,width:'100%',marginTop:hp(1)}}>
         <View
            style={{
              flexDirection: 'row',
 ...
 <View
            ...
            <View
              ...
              <View style={{marginHorizontal: hp(1)}}>
                <SimpleLineIcons name="heart" color="black" size={30} />
              </View>
              <View style={{marginHorizontal: hp(1)}}>
                <Ionicons name="chatbox-outline" color="black" size={30} />
              </View>
            </View>
...
export default SecondItemPublication
